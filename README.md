...
[![Moodle Plugin 
CI](https://github.com/moodle-an-hochschulen/moodle-theme_boost_union/workflows/Moodle%20Plugin%20CI/badge.svg?branch=master)](https://github.com/moodle-an-hochschulen/moodle-theme_boost_union/actions?query=workflow%3A%22Moodle+Plugin+CI%22+branch%3Amaster) [![GitHub Release](https://img.shields.io/github/release/moodle-an-hochschulen/moodle-theme_boost_union.svg)](https://github.com/moodle-an-hochschulen/moodle-theme_boost_union/releases)
